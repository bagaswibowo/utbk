...
class Peserta_daftar extends Member_Controller {
    ...
    function tambah(){
		...
		$this->form_validation->set_rules('tambah-email', 'Email','required|strip_tags');
		$this->form_validation->set_rules('tambah-asal-sekolah', 'Asal Sekolah','required|strip_tags');
		$this->form_validation->set_rules('tambah-provinsi', 'Provinsi','required|strip_tags');
		$this->form_validation->set_rules('tambah-kota', 'Kota','required|strip_tags');
		$this->form_validation->set_rules('tambah-jurusan', 'Jurusan','required|strip_tags');
		$this->form_validation->set_rules('tambah-instagram', 'Instagram','strip_tags');
		$this->form_validation->set_rules('tambah-whatsapp', 'No WA','required|strip_tags');
        $this->form_validation->set_rules('tambah-group', 'Program','required|strip_tags');
        ...
        if($this->form_validation->run() == TRUE){
			...
			$data['user_kota'] = $this->input->post('tambah-kota', true);
			$data['user_jurusan'] = $this->input->post('tambah-jurusan', true);
			$data['user_instagram'] = $this->input->post('tambah-instagram', true);
			$data['user_whatsapp'] = $this->input->post('tambah-whatsapp', true);
    ...
    function get_by_id($id=null){
		...
		if(!empty($id)){
			...
			if($query->num_rows()>0){
				...
				$data['provinsi'] = $query->user_provinsi;
				$data['kota'] = $query->user_kota;
				$data['jurusan'] = $query->user_jurusan;
				$data['instagram'] = $query->user_instagram;
				$data['whatsapp'] = $query->user_whatsapp;
				//selesai//
    ...
    function edit(){
		...
		$this->form_validation->set_rules('edit-email', 'Email','required|strip_tags');
		$this->form_validation->set_rules('edit-asal-sekolah', 'Asal Sekolah','required|strip_tags');
		$this->form_validation->set_rules('edit-provinsi', 'Provinsi','required|strip_tags');
		$this->form_validation->set_rules('edit-kota', 'Kota','required|strip_tags');
		$this->form_validation->set_rules('edit-jurusan', 'Jurusan','required|strip_tags');
		$this->form_validation->set_rules('edit-instagram', 'Instagram','strip_tags');
		$this->form_validation->set_rules('edit-whatsapp', 'No WA','required|strip_tags');
        $this->form_validation->set_rules('edit-group', 'Program','required|strip_tags');
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($pilihan=='hapus'){//hapus
				...
				$data['user_kota'] = $this->input->post('edit-kota', true);
				$data['user_jurusan'] = $this->input->post('edit-jurusan', true);
				$data['user_instagram'] = $this->input->post('edit-instagram', true);
				$data['user_whatsapp'] = $this->input->post('edit-whatsapp', true);
