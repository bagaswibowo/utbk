...
<section class="content-header">
    <h1>
        MALESAJA.COM
        <small> SIMULASI UJIAN ONLINE 2019</small>
    </h1>
</section>
...
<section class="content">
    <div class="callout callout-info">
        <h4>Informasi</h4>
        <p>Untuk mengakses aplikasi pendataan, gunakan salah satu dari browser 
		berikut melalui perangkat komputer PC ataupun Laptop : Mozilla Firefox, Google Chrome, Safari, atau Opera.
		</p>
    </div>
</section><!-- /.content -->
</div>
