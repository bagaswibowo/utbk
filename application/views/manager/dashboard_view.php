...
<section class="content">
	...
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Apabila admin/operator mendapatkan bug dalam aplikasi, silahkan kirim detail bug ke <a href="mailto:admin@tokota.id"> admin@tokota.id</a> atau via WhatsApp <a href="https://wa.me/082292097600">082292097600</a></p>
    </div>
    <div class="box">
        <div class="box-header with-border">
